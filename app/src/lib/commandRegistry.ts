...
export const COMMAND_DEFINITIONS = [
  ...
  },
  {
    ...
    titleEn: "Attention Center",
    descriptionEn: "Review completions, questions, permission requests, and stale status",
  ...
  },
  {
    ...
    titleEn: "Find in current terminal",
    descriptionEn: "Search the current xterm scrollback",
  ...
  },
  {
    ...
    titleEn: "New session",
    descriptionEn: "Create a new AI session in the current project",
  ...
  },
  {
    ...
    titleEn: "New project",
    descriptionEn: "Register a new working folder",
  ...
  },
  {
    ...
    titleEn: "Close current pane",
    descriptionEn: "Detach from the current screen while keeping the session PTY alive",
  ...
  },
  {
    ...
    titleEn: "Reopen closed tab",
    descriptionEn: "Restore the last closed tab to its original screen and pane",
  ...
  },
  {
    ...
    titleEn: "Toggle file tree",
    descriptionEn: "Toggle the current project's file tree sidebar",
  ...
  },
  {
    ...
    titleEn: "Toggle Desktop Pet",
    descriptionEn: "Toggle the work-status pet",
  ...
  },
  {
    ...
    title: "창 상시 최상단 전환",
    description: "Acedia 창 고정 상태 전환",
    titleEn: "Toggle always on top",
    descriptionEn: "Toggle whether the Acedia window stays on top",
  ...
  },
  {
    ...
    titleEn: "New Acedia window",
    descriptionEn: "Open a secondary Electron window",
  ...
  },
  {
    id: "settings",
    title: "설정 열기",
    description: "Acedia 설정 열기",
    titleEn: "Open settings",
    descriptionEn: "Open Acedia settings",
