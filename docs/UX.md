...
- Remote chat recognizes project-local Markdown, HTML, and image paths in user/assistant messages. Markdown and images open in a viewport-filling preview overlay; HTML navigates to the owning project's Documents screen and selects the matching document for the full sandboxed viewer
