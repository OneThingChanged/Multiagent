...
- The Remote message composer accepts clipboard-pasted PNG, JPEG, GIF, WebP, and BMP images through the same upload path and limits as the attachment picker (up to four files, 8 MB each)
