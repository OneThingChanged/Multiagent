...
- Remote chat recognizes project-local Markdown and image paths in user/assistant messages and opens them in a viewport-filling preview overlay; Markdown reuses the document renderer and images are streamed through a sandboxed, project-root-bounded endpoint
